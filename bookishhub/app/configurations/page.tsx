        ...
        <div className="flex 
            ...
            <div className="bg-secondary 
                            ...
                            <div className="ml-5">
                                ...
                                Whether you’re starting a new membership or upgrading an existing one, everything you need is just a click away. Press the button below to join the BookishHub Power community or access even more options to elevate your experience.                
                            </div>
            </div>
